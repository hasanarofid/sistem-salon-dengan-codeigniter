           ...
           <div class="col-xl-12 col-lg-7">
               ...
               <div class="card shadow">
                   <div class="card-header py-3">
                       <h6 class="m-0 font-weight-bold text-info">Layanan Kabag Umum</h6>
                   </div>
                       ...
                       <div class="row no-gutters align-items-center">
                           <div class="col mr-2">
                               ...
                               <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $total = 0;
                                                                                    foreach ($datajumlahlayananhkt as $dt) : {
                                                                                    ...
                                                                                    ?> HKT</div>
                               <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $total = 0;
                                                                                    foreach ($datajumlahlayanantu as $dt) : {
                                                                                            if ($dt->id_status_layanan <> '1f7e6gj') {
                                                                                                $total = $total + $dt->total;
                                                                                            }
                                                                                        }
                                                                                    ...
                                                                                    ?> TU</div>
                               <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $total = 0;
                                                                                    foreach ($datajumlahlayanankeu as $dt) : {
                                                                                            if ($dt->id_status_layanan <> '1f7e6gj') {
                                                                                                $total = $total + $dt->total;
                                                                                            }
                                                                                        }

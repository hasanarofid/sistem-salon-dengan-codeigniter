        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <?php if ($get_row_detail_layanan->id_sp == 'b7218a04-cc6b-11ed-ae35-6c3c8c5f1f57') { ?>
                        <?php
                        if ($status == "3f9j9h7s") {
                        ?>
                            <select class="form-control select2bs4" id="id_status_layanan" name="id_status_layanan" required>
                                ...
                                <?php
                                foreach ($get_status_proses_ajuan_diperiksa as $row) : ?>
                        ...
                        if ($status == "4f4s8rs") { ?>
                            <select class="form-control select2bs4" id="id_status_layanan" name="id_status_layanan" required>
                                <option value="">-- Status Layanan --</option>
                                <?php
                                foreach ($get_status_proses_ajuan_diproses_yudisium as $row) : ?>
                                    <option value="<?= $row->id_status_layanan; ?>"><?= $row->nama_status_layanan; ?></option>
                                <?php endforeach; ?>
                            </select>
                        <?php } ?>
                    <?php } else { ?>
                        ...
                        if ($status == "4f4s8rs") { ?>
                            <select class="form-control select2bs4" id="id_status_layanan" name="id_status_layanan" required>
                                <option value="">-- Status Layanan --</option>
                                <?php
                                foreach ($get_status_proses_ajuan_diproses as $row) : ?>
                                    <option value="<?= $row->id_status_layanan; ?>"><?= $row->nama_status_layanan; ?></option>
                                <?php endforeach; ?>
                            </select>
                        <?php } ?>

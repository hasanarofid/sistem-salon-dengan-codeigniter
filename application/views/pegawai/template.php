...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php echo $menu == 'layanan' ? 'active' : '' ?>">
                ...
                <div id="layanan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php echo $sub_menu == 'pengajuan_layanan' ? 'active' : '' ?>" href="<?= base_url('pegawai/pengajuan_layanan'); ?>">Pengajuan Layanan</a>
                        <a class="collapse-item <?php echo $sub_menu == 'pengajuan_layanan_konsultasi' ? 'active' : '' ?>" href="<?= base_url('pegawai/pengajuan_layanan_konsultasi'); ?>">Pengajuan Layanan <br>Konsultasi</a>
                        <a class="collapse-item <?php echo $sub_menu == 'riwayat_layanan' ? 'active' : '' ?>" href="<?= base_url('pegawai/riwayat_layanan'); ?>">Riwayat Layanan</a>
                    </div>
                </div>
            </li>

   <div class="container-fluid">
       ...
       <div class="row">
           <div class="col-xl-12 mb-4">
               <div class="card shadow h-100 py-1">
                   <div class="card-body">
                       <h5 class="h5 mb-0 text-gray-700"> Selamat Datang di Dashboard Pinandu LLDIKTI XI</h5> <br />
                       Silahkan kirimkan kritik, saran dan masukan anda untuk aplikasi PINANDU  melalui menu disamping sebagai bahan evaluasi kami !
                   </div>
               </div>
           </div>
       </div>
       ...
       <div class="row">
           ...
           <div class="col-xl-3 col-md-6 mb-4">
               <div class="card border-bottom-light shadow h-100 py-2">
                   <div class="card-body">
                       <div class="row no-gutters align-items-center">
                           <div class="col mr-2">
                               ...
                               <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $total = 0;
                                                                                    foreach ($datajumlahlayanan as $dt) : {
                       ...
                       <div class="row no-gutters align-items-center">
                           <div class="col mr-2">
                               <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                   Layanan Belum Diajukan</div>
                               <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $data = 0;
                                                                                    foreach ($datajumlahlayanan as $dt) : {
                                                                                            if ($dt->nama_status_layanan == 'Belum diajukan') {
                                                                                                $data = $data + $dt->total;
                                                                                            }
                                                                                        }
                                                                                    endforeach;
                   ...
                   <div class="card-body">
                       <?php $dtbagian = "[";
                        ...
                        foreach ($databagian as $dt) {
                            ...
                            $datajumlah = $this->pts_model->get_dttotallayananbg($dt->id_bagian, $kode_pt)->row_array();

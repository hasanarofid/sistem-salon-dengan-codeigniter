<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <?php if ($status == '7d9aj39' or $status == '1f7e6gj') : ?>
            <form action="<?= base_url('pts/action_kirim_ajuan') ?>" method="post" onsubmit="return confirm('Yakin akan mengirim tiket? Tiket yang dikirim tidak bisa dirubah lagi');">
                ...
                <button type="submit" name="submit" class=" btn btn-sm btn-info shadow-sm">
